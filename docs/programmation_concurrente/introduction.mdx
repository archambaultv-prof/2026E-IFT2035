...
Dans ce cours, nous étudions ces concepts à travers des exemples en Python.
Des exemples en C et en Haskell seront ajoutés ultérieurement pour illustrer
comment d'autres langages abordent les mêmes défis. Nous allons voir dans les
prochaines sections trois paquets principaux de Python pour illustrer ces
conceptes :
